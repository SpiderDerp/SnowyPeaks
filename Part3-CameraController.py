...
class CameraController():
    def __init__(self, to_follow, to_move, platform_gen):
        self.to_follow = to_follow
        self.to_move = to_move
        self.platform_gen = platform_gen
    ...
    def scroll_up(self, dist):
        ...
        self.platform_gen.on_scroll_down(dist)
...
controller = CameraController(player, terrain_sprites, generator)
...
def main():
    while True:  # Game loop
        ...
        # TODO this is new, instantiate and operate camera controller
        controller.follow()
